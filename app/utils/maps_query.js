...
// /**
//  * Retrieves the placeId of a specified place in a given location.
//  *
//  * @param {string} placeName - The name of the place to search for.
//  * @param {string} location - The location in which to search for the place.
//  *
...
//  */
// async function fetchPlaceId(placeName, location) {
//   try {
//     const encodedPlaceName = encodeURIComponent(placeName);
//     const encodedLocation = encodeURIComponent(location);
//     const url =
// `${MAP_API}/json?query=${encodedPlaceName}%20in%20${encodedLocation}&key=${process.env.GOOGLE_MAPS_API_KEY}`;
